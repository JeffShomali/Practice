                        ...
                        <div className="col-md-8">
                             <div className="row">
                                  <div className="col-md-12">
                                        <span className="label label-primary">{this.props.userData.public_repos} Repositories</span>
                                  ...
                                  <div className="col-md-12">
                                       <ul className="list-group">
                                            <li className="list-group-item"><strong>Username: </strong>{this.props.userData.login}</li>
                                             ...
                                             <li className="list-group-item"><strong>Username: </strong>{this.props.userData.email}</li>
                                       </ul>
                                  </div>
                             </div>
                        </div>
